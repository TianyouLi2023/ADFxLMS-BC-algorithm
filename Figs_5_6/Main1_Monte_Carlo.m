...
Men_Num = 1;      % The number of the Monte Carlo simulation
window_length = 100; % Moving-average window length
...
% Fig. 5. Comparison of the simulations residual noise by different algorithms in the free field.  
En_CDLMS(1,1)=0;En_DCLMS(1,1)=0;En_MDLMS(1,1)=0;En_BDLMS(1,1)=0;En_MDLMS_VSR(1,1)=0;En_BDLMS_NBC(1,1)=0;
figure;tt=0:1/Fs:Ts-window_length/Fs;ss=1998;
...
% Fig. 6. The converged global control filters of (a) CFxLMS, (b) DCFxLMS (c) MDFxLMS, (d) MDFxLMS-VSR, (e) ADFxLMS and (f) ADFxLMS-BC algorithms in the free field. 
figure;plot(Wn_Global_C,'Color',[255 0 0]/255);legend('CFxLMS','FontSize',16,'FontName','Times New Roman','Location','southwest');grid on;
set(gca,'FontSize',16,'FontName','Times New Roman');axis([0 w_L*Num_WFS_source -0.1 0.03])
xlabel('Tap','FontName','Times New Roman','FontSize',16);ylabel('Global Control Filter','FontName','Times New Roman','FontSize',16);

figure;plot(Wn_Global_DC,'Color',[0 0 0]/255);legend('DCFxLMS','FontSize',16,'FontName','Times New Roman','Location','southwest');grid on;
set(gca,'FontSize',16,'FontName','Times New Roman');
xlabel('Tap','FontName','Times New Roman','FontSize',16);ylabel('Global Control Filter','FontName','Times New Roman','FontSize',16);

figure;plot(Wn_Global_MD,'Color',[255 0 255]/255);legend('MDFxLMS','FontSize',16,'FontName','Times New Roman','Location','southwest');grid on;
set(gca,'FontSize',16,'FontName','Times New Roman');axis([0 w_L*Num_WFS_source -0.1 0.03])
xlabel('Tap','FontName','Times New Roman','FontSize',16);ylabel('Global Control Filter','FontName','Times New Roman','FontSize',16);

figure;plot(Wn_Global_MD_VSR,'Color',[0 180 20]/255);legend('MDFxLMS-VSR','FontSize',16,'FontName','Times New Roman','Location','southwest');grid on;
set(gca,'FontSize',16,'FontName','Times New Roman');axis([0 w_L*Num_WFS_source -0.1 0.03])
xlabel('Tap','FontName','Times New Roman','FontSize',16);ylabel('Global Control Filter','FontName','Times New Roman','FontSize',16);

figure;plot(Wn_Global_GD,'Color',[155 20 100]/255);legend('ADFxLMS','FontSize',16,'FontName','Times New Roman','Location','southwest');grid on;
set(gca,'FontSize',16,'FontName','Times New Roman');axis([0 w_L*Num_WFS_source -0.1 0.03])
xlabel('Tap','FontName','Times New Roman','FontSize',16);ylabel('Global Control Filter','FontName','Times New Roman','FontSize',16);

figure;plot(Wn_Global_GD_ATCC,'Color',[0 0 255]/255);legend('ADFxLMS-BC','FontSize',16,'FontName','Times New Roman','Location','southwest');grid on;
set(gca,'FontSize',16,'FontName','Times New Roman');axis([0 w_L*Num_WFS_source -0.1 0.03])
xlabel('Tap','FontName','Times New Roman','FontSize',16);ylabel('Global Control Filter','FontName','Times New Roman','FontSize',16);